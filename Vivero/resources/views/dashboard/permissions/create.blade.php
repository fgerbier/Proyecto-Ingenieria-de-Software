...
<div class="max-w-xl mx-auto py-10">
    <h1 class="text-2xl font-bold text-eprimary mb-6">Crear nuevo permiso</h1>
    ...
    <form action="{{ route('permissions.store') }}" method="POST" class="bg-white shadow rounded px-6 py-8">
        @csrf
        <div class="mb-4">
